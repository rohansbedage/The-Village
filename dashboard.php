                    ...
                    <div class="main-content container-fluid">
                        <div class="splash-container ">
                            ...
                            <div class="card card-border-color card-border-color-primary shadow-lg  ">
                                <div class="card-header"><img class="logo-img" src="vlogo.jpeg" alt="logo" width="{conf.logoWidth}" height="57"><span class="splash-description"><br> <b>Please enter your new password.</b> </span></div>
                                <div class="card-body ">
