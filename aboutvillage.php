...
<body class="bg-white">
  ...
  <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 mx-5 ">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <div class="col-lg-4 p-3 p-lg-5 pt-lg-3">
      <img class="rounded-lg-3" src="images/about-village/1.jpg" alt="" width="520">
    </div>
    <div class="col-lg-5 offset-lg-1 p-0 overflow-hidden text-center">
      ...
      <p><br>
        ...
        The history of Mahabaleshwar goes back to the 13th Century when the Yadav king Singhan built a temple dedicated to Lord Mahadev at the source of the five holy rivers (Panch Ganga) Koyna, Krishna, Gayatri, Savitri and Venna. It is from this Mahadev Temple that the place derives its name Mahabaleshwar. </p>
    ...
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      <div class="col d-flex align-items-start">
        ...
        <div>
          <h2>Location</h2>
          <p>
            At a distance of 54 km from Satara, 123 km from Pune, 177 km from Kolhapur, 243 km from Mumbai, and 377 km from Panaji, Mahabaleshwar is a scenic hill town in Satara district of Maharashtra. At an altitude of 1,353 m in the Western Ghats, it is one of the popular hill stations in India,
      ...
      <div class="col d-flex align-items-start">
        ...
        <div>
          <h2>Climate</h2>
          <p>
            In Mahabaleshwar, India, is a moderately hot winter month, with temperature in the range of an average high of 23.6°C (74.5°F) and an average low of 8.9°C (48°F). In January, the average high-temperature is relatively the same as in December - a still moderately hot 23.6°C (74.5°F).
    ...
    <div class="content">
      ...
      <div class="container" style="width:1200px;"></br></br></br></br>
        ...
        <div class="container" style="width: 1200px; height: 500px;">
          ...
          <p>The annual average rate of change of population size, for a given country, territory, or geographic area, during a specified period. It expresses the ratio between the annual increase in the population size and the total population for that year, usually multiplied by 100.</p>
          <center>
            <div id="chart2"></div>
          </center>
...
<div class="jumbotron jumbotron-fluid bg-light">
  <div class="container">
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
      ...
      <div class="col-lg-6">
        <img src="images/about-village/2.jpg" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="400" height="500" loading="lazy">
