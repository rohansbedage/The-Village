...
<body class="bg-light">
        ...
        <div class="be-right-navbar">
          <ul class="nav navbar-nav float-right be-user-nav">
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><img src="images/avatar/avatar1.png" alt="Avatar"><span class="user-name"></span></a>
  ...
  <header class="d-flex justify-content-center py-3 shadow">
    <ul class="nav nav-pills ">
      <h4>
        <li class="nav-item shadow-lg"><a href="" class="nav-link active" aria-current="page">Home</a></li>
      </h4> &nbsp;&nbsp;&nbsp;
      <h4>
  ...
  <div class="container my-5 ">
    ...
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5 mx-5">
      <div class="col-10 col-sm-8 col-lg-6 ">
        ...
        <script src="includes/anychart-base.min.js" type="text/javascript"></script>
        <script>
    ...
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5 my-5">
      ...
      <div class="col-lg-6">
        ...
        <div class="mapouter">
          <div class="gmap_canvas"><iframe class="gmap_iframe" width="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=637&amp;height=443&amp;hl=en&amp;q=mahablashwar&amp;t=h&amp;z=13&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe><a href="https://www.fridaynightfunkin.net/">FNF Download</a></div>
          <style>
            .mapouter {
              position: relative;
              text-align: right;
  ...
  <div class="container col-xxl-8 px-4 py-5">
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5 shadow-lg">
      <div class="col-10 col-sm-8 col-lg-6">
        <img src="images/visitors-page/1.jpg" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy">
      </div>
      <div class="col-lg-6">
    ...
    <div class="gallery-container">
      <div class="item">
        <div class="photo">
          <div class="img"><img src="images/visitors-page/2.jpg" alt="Gallery Image">
            <button type="button" class="my-3 image-zoom btn btn-block btn-primary  shadow-lg" href="images/visitors-page/2.jpg">View Image</button>
      ...
      <div class="item">
        <div class="photo">
          <div class="img"><img src="images/visitors-page/3.jpg" height="145rem" alt="Gallery Image"><br><br>
            <button type="button" class="my-4 image-zoom btn btn-block btn-primary  shadow-lg" href="images/visitors-page/3.jpg">View Image</button>
      ...
      <div class="item">
        <div class="photo">
          <div class="img"><img src="images/visitors-page/4.jpg" alt="Gallery Image">
            <button type="button" class="my-3 image-zoom btn btn-block btn-primary  shadow-lg" href="images/visitors-page/4.jpg">View Image</button>
      ...
      <div class="item">
        <div class="photo">
          <div class="img"><img src="images/visitors-page/5.PNG" height="145rem" alt="Gallery Image"><br><br>
            <button type="button" class="my-4 image-zoom btn btn-block btn-primary  shadow-lg" href="images/visitors-page/5.PNG">View Image</button>
