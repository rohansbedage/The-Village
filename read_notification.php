        ...
        <div class="be-right-navbar">
          <ul class="nav navbar-nav float-right be-user-nav">
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><img src="images/avatar/avatar1.png" alt="Avatar"><span class="user-name">Túpac Amaru</span></a>
                  ...
                  <div class="be-scroller-chat bg-white">
                    <div class="content ">
                      ...
                      <div class="">
                        <div class="user">
                          <a href="post.php">
                            <div class="user-data"><span class="name">Claire
                                Sassu</span><span class="message">Can you share
                                the...</span></div>
                          </a>
                        </div>
                ...
                <div class="job-box d-md-flex align-items-center justify-content-between mb-30">
                  <div class="job-left my-4 d-md-flex align-items-center">
                    ...
                    <div class="job-content">
                      <h4 class="text-center text-dark text-md-left">
                        <?php echo $main_result['name']; ?> &nbsp; (
                        <?php echo $main_result['cr_date']; ?>)</h4>
                      <ul class="d-md-flex flex-wrap text-capitalize ff-open-sans">
                        <li class="mr-md-4">
                          <h4> <i class="zmdi zmdi-pin mr-2"></i>
                            <?php echo $main_result['message']; ?></h4>
                        </li>
