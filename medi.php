...
<body clas="bg-light">
    ...
    <div class="jumbotron jumbotron-fluid bg-light text-center shadow-lg">
        ...
        <p class="lead">"Village Health: Nurturing Wellness at the Heart of Community"</p>
    </div>
            ...
            <div class="col-lg-7 text-center text-lg-start">
                ...
                <div class="row my-5 shadow-lg">
                    ...
                    <div class="col-4 ">
                        ...
                        <h3>
                            <div class="desc fw-bold">Active Patients</div>

                            <div class="value"></span><span class="number" data-toggle="counter"
                                    data-end="<?php echo $rowsactive ?>">0</span>
                            </div>
                        </h3>
                    ...
                    <div class="col-4">
                        ...
                        <h3>
                            <div class="desc "> Recovered </div>
                            <div class="value text-success"></span><span class="number" data-toggle="counter"
                                    data-end="<?php echo $rowsrecovered ?>">0</span>
                    ...
                    <div class="col-4 ">
                        ...
                        <h3>
                            <div class="desc">Dead Patients</div>
                            <div class="value text-danger"></span><span class="number" data-toggle="counter"
                                    data-end="<?php echo $rowsdead ?>">0</span>
        ...
        <div class="container ">
            ...
            <div class="jumbotron jumbotron-fluid bg-light text-center shadow-sm">
                <div class="container">
                    ...
                    <p class="lead">Below are the detailed information About perticular Hospital Bed Status , swipe
                        right to check more Hospitals.</p>
                </div>
            </div>
            ...
            ?> <div class="card text-center   shadow-lg my-2" style="width: 20rem;">
                            <div class="card-body ">
                                ...
                                <a href="#"
                                    class="btn btn-lg btn-primary shadow-lg text-uppercase"><?php echo htmlentities($row['HospitalName']); ?></a>
                                <hr>

                                <h4 class="text-success shadow-lg"><br> <b> Available Normal Beds : <br>
                                        <?php echo htmlentities($row['AvailableNormalBeds']); ?> <br><br></b> </h4>
                                <hr>
                                <h4 class="text-success shadow-lg"> <br> <b> Hospital Ventilator Bed : <br>
                                        <?php echo htmlentities($row['AvailableVentilatorBeds']); ?></b> <br><br></h4>
                                <hr>
...
<div class="jumbotron jumbotron-fluid bg-light text-center my-3 shadow-sm">
    <div class="container">
        ...
        <p>
        <h4>(Get Pre-Appointment on calling their Contact number.)*</h4>
        </p>
...
<table class="table table-bordered table-striped my-3">
  ...
  ?>
        ...
        <script>
        fetch(
                'https://script.google.com/macros/s/AKfycbxtdAbwaiBzPM8ld0T8tiD5U7bI6zzWcgDUWiCNJBFiNknrzd6WgMhZSvVaM2hQGg/exec')
            .then(res => res.json())
            .then(data => {
