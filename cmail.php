...
if (isset($_POST['send'])) {
  ...
  $a = mysqli_query($con, "insert into ticket(ticket_id,email_id,subject,ticket,status,posting_date)  values('$tid','$email','$subject','$ticket','$st','$pdate')");
}
              ...
              <div class="card-body pt-0 pt-md-4">
                <div class="row">
                  <div class="col">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <img src="images/profile/1.png" alt="Admin" class="rounded-circle p-1" width="110">
                    ...
                    <div class="email-compose-fields">
                      ...
                      <div class="subject">
                        <div class="form-group row pt-2">
                          ...
                          <div class="col-md-11">
                            <input class="form-control" id="inputReadonly3" type="text" readonly="readonly" value="admin@gmail.com">
                          </div>
                      ...
                      <div class="subject">
                        <div class="form-group row pt-2">
                          ...
                          <div class="col-md-11">
                            <input class="form-control" name="subject" type="text" required class="form-control" autocomplete="off">
                          </div>
                        </div>
                      </div>
                      <div class="subject">
                        <div class="form-group row pt-2">
                          ...
                          <div class="col-md-11">
                            <textarea class="form-control" name="description" required="true" id="subject" style="height: 150px" placeholder="Click here to Add Complent " required class="form-control"></textarea>
                            <div class="row pt-3">
                              ...
                              <div class="col-sm-6">
                                <p class="text-right">
                                  <button class="btn btn-space btn-primary" value="Send" name="send" type="submit">Submit</button>
