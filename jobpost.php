...
$query2 = "SELECT * FROM joblist where cat='$nale'";
                            ...
                            <div class="container shadow bg-light">
                                <article class="blog-post ">
                                    <div class="featured-post">
                                        <a href="#">
                                            <img src="https://i.picsum.photos/id/1057/1200/600.jpg" alt="">
                                        </a>
                                    </div>
                                    ...
                                    <div class="content ">
                                        ...
                                        <div class="entry-post">
                                            ...
                                            <div class="more-link">
                                                ...
                                                <a class="btn btn-lg shadow-lg" href="jobdetails.php?id=<?php echo $id ?>"> Read More</a>
                                                <hr>
                                            </div>
                                        </div>
                                    </div>
