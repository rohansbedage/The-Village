...
<body>
  ...
  <div class="be-wrapper be-fixed-sidebar">
                ...
                <ul class="sidebar-elements">
                  ...
                  <li class="parent "><a href="#"><i class="icon mdi mdi-hospital"></i><span> Medical
                    ...
                    <ul class="sub-menu">
                      ...
                      <li class="active"><a href="DeadPatientlist.php">Dead Patients</a>
                      </li>
                    </ul>
                  </li>
    ...
    <div class="be-content">
      <div class="page-head">
        <h2 class="page-head-title">Dead Patients</h2>
        <nav aria-label="breadcrumb" role="navigation">
          <ol class="breadcrumb page-head-nav">
            <li class="breadcrumb-item"><a href="#">Admin</a></li>
            <li class="breadcrumb-item"><a href="#">Important</a></li>
            <li class="breadcrumb-item active">Dead Patients</li>
          </ol>
        </nav>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="card card-table">
              <div class="card-header">List of Dead Patients
              ...
              <div class="card-body">
                <table class="table table-striped table-hover table-fw-widget" id="table3">
                  ...
                  <tbody>
                    ...
                    <?php
                    $query = mysqli_query($con, "Select id,PatientName,Age,gender,AdmitDate,UpdationDate from  Patient where PatientStatus='Dead'");
                    $cnt = 1;
