...
if (isset($_POST['save'])) { // if save button on the form is clicked
  ...
  $sql = "INSERT INTO home1 (name, des,day,month) VALUES ('$name', '$detail','$da','$da1')";
  if (mysqli_query($conn, $sql)) {
    echo "<script>alert('Data Incerted Succesfully ');</script>";
    echo "<script>window.location.href='importantnotice.php'</script>";
  } else {
                ...
                <ul class="sidebar-elements">
                  ...
                  <li class="parent "><a href="#"><i class="icon mdi mdi-alert-triangle"></i><span>
                    ...
                    <ul class="sub-menu">
                      ...
                      <li class="active"><a href="importantnotice.php">Important Notices</a>
                      </li>
    ...
    <div class="be-content">
      <div class="main-content container-fluid">
        <div class="card text-center">
          <div class="card-header card-header-divider">Important Notice Upload<span class="card-subtitle"></span></div>
          <div class="card-body">
            <form action="importantnotice.php" method="post">
              ...
              <div class="form-group row ">
                ...
                <div class="col-sm-4 col-lg-3 mb-3  mb-sm-0">
                  ...
                  <input class="form-control " type="text" name="name" required="" placeholder="News Title">
                </div>
                <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">

                  <input class="form-control" type="text" name="detail" required="" placeholder="Short details">
                </div>
                ...
                <div class="col-sm-4 col-lg-3 my-1">
                  <button type="submit" name="save" class="btn btn-primary btn-lg btn-block">Add Notice</button>
                </div>
              </div>
          ...
          <div class="col-sm-12">
            <div class="card card-table">
              ...
              if ($type == 'temp') {
                ...
                $id = $_GET['id'];
                if ($saurabh == 'deactive') {
                  $update_status_sql = "DELETE FROM home1 where Id='$id'";
