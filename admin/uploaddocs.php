<!DOCTYPE html>
<html lang="en">
<?php include 'userdocsupload.php'; ?>
...
<body>
  ...
  <div class="be-wrapper be-fixed-sidebar">
              ...
              <div class="left-sidebar-content">
                ...
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href=""><i class="icon mdi mdi-file-text"></i><span>Documentation</span></a>
                    <ul class="sub-menu">
                      <li class="active"><a href="uploaddocs.php">Uplod Docs</a>
                      </li>
    ...
    <div class="be-content">
      <div class="page-head">
        <h2 class="page-head-title">upload docs</h2>
        <nav aria-label="breadcrumb" role="navigation">
          <ol class="breadcrumb page-head-nav">
            <li class="breadcrumb-item"><a href="#">Admin</a></li>
            <li class="breadcrumb-item"><a href="#">Documentation</a></li>
            <li class="breadcrumb-item active">Upload docs</li>
          </ol>
        </nav>
      </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-border-color card-border-color-primary">
              <div class="card-header card-header-divider">upload docs</div>
              <div class="card-body">
                <form action="uploaddocs.php" method="post" enctype="multipart/form-data">

                  <div class="form-group row">
                    <label class="col-12 col-sm-3 col-form-label text-sm-right">Enter Mobile Number :</label>
                    <div class="col-12 col-sm-8 col-lg-6">
                      <input class="form-control" type="text" placeholder="Type something" type="text" name="mobile"> <br>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-12 col-sm-8 col-lg-6">
                      <input class="form-control" type="file" name="myfile2">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-12 col-sm-3 col-form-label text-sm-right">Add Income Document :</label>
                    <div class="col-12 col-sm-8 col-lg-6">
                      <input class="form-control" type="file" name="myfile3">
                    </div>
                  </div>
