...
<body>
    ...
    <div class="be-wrapper be-fixed-sidebar">
                                ...
                                <ul class="sidebar-elements">
                                    ...
                                    <li class="parent"><a href=""><i class="icon mdi mdi-format-list-numbered"></i><span>Schemes</span></a>
                                        <ul class="sub-menu">
                                            ...
                                            <li class="active"><a href="schemes.php">View Schemes</a> </li>
        ...
        <div class="be-content">
            <div class="page-head">
                <h2 class="page-head-title">Village Schemes</h2>
            ...
            <div class="main-content container-fluid">
                ...
                if ($type == 'temp') {
                    ...
                    $id = $_GET['id'];
                    if ($saurabh == 'deactive') {
                        $update_status_sql = "DELETE FROM schmedetail where id='$id'";
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-table">
                            <div class="card-header">Village Schemes
