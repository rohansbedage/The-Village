    ...
    <div class="be-wrapper be-fixed-sidebar">
                  ...
                  <ul class="sidebar-elements">
                    ...
                    <li class="parent"><a href=""><i class="icon mdi mdi-local-library"></i><span>JOB
                      ...
                      <ul class="sub-menu">
                        ...
                        <li class="active"><a href="Totaljobs.php">Available Jobs</a>
                        </li>
      ...
      <div class="be-content">
        ...
        if (isset($_POST['upload'])) {
          ...
          $sql = "INSERT INTO joblist(img,name,des,cat) VALUES ('$filename','$name','$des','$jobcat')";
        ...
        <div class="main-content container-fluid">
          <div class="card text-center">
            <div class="card-header card-header-divider">Add new job</div>
            <div class="card-body">
              <form method="POST" action="" enctype="multipart/form-data">
                <div class="form-group row">
                  <label class="col-12 col-sm-3 col-form-label text-sm-right text-light">Equal To</label>
                  <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                    <input class="form-control" type="text" name="name" value="" id="pass2" type="password" required="" placeholder="Job Name">
                  </div>
                  <div class="col-sm-4 col-lg-3">

                    <?php
                    $db = mysqli_connect("localhost", "root", "", "rohan");
                    $code = "SELECT * FROM jobcat";
                    $res = mysqli_query($db, $code);

                    ?>
                    <select class="form-control" id="jobcatagory" name="jobcatagory">

                      <option selected="">jobcatagory</option>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-12 col-sm-8 col-lg-6">
                    <textarea class="form-control" name="details" id="inputTextarea3"></textarea>
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <label class="col-12 col-sm-3 col-form-label text-sm-right text-light">Equal To</label>
                  <div class="col-sm-4 col-lg-3">
                    <input class="form-control" type="file" name="uploadfile" value="" placeholder="details" id="pass2" required="">
                  </div>
          ...
          <div class="col-sm-12">
            <div class="card card-table">
              ...
              if ($type == 'temp') {
                ...
                $id = $_GET['id'];
                if ($saurabh == 'deactive') {
                  $update_status_sql = "DELETE FROM joblist where id='$id'";
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr class="odd gradeX">
                        ...
                        <td><img width="50" height="20" src="postimages/<?php echo $row['img']; ?>"></td>
