...
if ($_GET['action'] = 'del') {
    ...
    $query = mysqli_query($con, "update place set Is_Active=0 where id='$postid'");
    if ($query) {
        $msg = "Post deleted ";
    } else {
...
if ($_GET['presid']) {
    ...
    $query = mysqli_query($con, "delete from  place  where id='$id'");
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-table">
                            <div class="card-header">Manage places
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <tr class="odd gradeX text-center">
                                                ...
                                                <td>
                                                    &nbsp;
                                                    <a class="btn btn-secondary" type="button" href="editplace.php?pid=<?php echo htmlentities($row['postid']); ?>">Edit</a>

                                                    <a class="btn btn-secondary" type="button" href="manageplace.php?presid=<?php echo htmlentities($row['postid']); ?>&&action=perdel" title="Delete forever">Delete</a>
