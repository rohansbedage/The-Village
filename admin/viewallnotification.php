...
<body>
    ...
    <div class="be-wrapper be-fixed-sidebar">
                                ...
                                <ul class="sidebar-elements">
                                    ...
                                    <li class="parent"><a href="#"><i class="icon mdi mdi-notifications-active"></i><span>Notification</span></a>
                                        <ul class="sub-menu">
                                            ...
                                            <li class="active"><a href="viewallnotification.php">Manage notifications</a>
                                            </li>
        ...
        <div class="be-content">
            <div class="page-head">
                <h2 class="page-head-title">Manage notifications</h2>
                            ...
                            <div class="card-body">
                                <table class="table table-striped table-hover table-fw-widget" id="table3">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $sr_no = 1;
                                        $sql_get = mysqli_query($con, "SELECT * FROM message ");
                                        while ($main_result = mysqli_fetch_assoc($sql_get)) : ?>
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td><a href="delete.php?id=<?php echo $main_result['id']; ?>" class="text-danger"><i class="fas fa-trash-alt"></i> Delete</a></td>
                                            </tr>
                                        <?php endwhile ?>
                                    </tbody>
