...
<body>
  ...
  <div class="be-wrapper be-fixed-sidebar">
                ...
                <ul class="sidebar-elements">
                  ...
                  <li class="parent "><a href="#"><i class="icon mdi mdi-hospital"></i><span> Medical
                    ...
                    <ul class="sub-menu">
                      ...
                      <li class="active"><a href="RecoveredPatients.php">Recovered Patients</a>
                      </li>
    ...
    <div class="be-content">
      <div class="page-head">
        <h2 class="page-head-title">Recovered Patients</h2>
        <nav aria-label="breadcrumb" role="navigation">
          <ol class="breadcrumb page-head-nav">
            <li class="breadcrumb-item"><a href="#">Admin</a></li>
            <li class="breadcrumb-item"><a href="#">Important</a></li>
            <li class="breadcrumb-item active">Recovered Patients</li>
          </ol>
        </nav>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="card card-table">
              <div class="card-header">Recovered Patients
              ...
              <div class="card-body">
                <table class="table table-striped table-hover table-fw-widget" id="table3">
                  ...
                  <tbody>
                    ...
                    <?php
                    $query = mysqli_query($con, "Select id,PatientName,Age,gender,AdmitDate,UpdationDate from  Patient where PatientStatus='Recovered'");
                    $cnt = 1;
                        ...
                        <td class="center">
                          <div class="btn-group btn-hspace">
                            ...
                            <div class="dropdown-menu" role="menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 30px, 0px);">
                              ...
                              <a class="dropdown-item" href="ActivePatients.php?resid=<?php echo htmlentities($row['id']); ?>">Again Affected</a>
