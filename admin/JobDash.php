...
$sql = "select * from appliedjobs where temp='0'";
...
<body>
    ...
    <div class="be-wrapper be-fixed-sidebar">
        ...
        <div class="be-content">
            ...
            <!---------------------------------------------------------------------------------------------------------------------------->
            <div class="page-head">
                <h2 class="page-head-title">Job applications</h2>
            ...
            <div class="col-sm-12 my-5">
                <div class="card card-table my-5">
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_assoc($res)) {
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><a href="viewcv.php?id=<?php echo $id ?>">View</a></td>
                                        ...
                                        <td> <?php
                                                if ($row['temp'] == 0) {
                                                    echo "<span><a href='?type=temp&saurabh=deactive&id=" . $row['id'] . "'>delete</a></span>&nbsp;&nbsp;&nbsp;";
                                                } ?></td>
