...
if (isset($_POST['update'])) {
    $imgfile = $_FILES["postimage2"]["name"];
    ...
    if (!in_array($extension, $allowed_extensions)) {
        ...
        $imgnewfile2 = md5($imgfile) . $extension;
        // Code for move image into directory
        move_uploaded_file($_FILES["postimage2"]["tmp_name"], "postimages/" . $imgnewfile2);

        $postid = intval($_GET['pid']);
        $query = mysqli_query($con, "update place set postimage2='$imgnewfile2' where id='$postid'");
        if ($query) {
        ...
        <div class="be-content">
            ...
            <div class="page-head">
                <div class="card card-border-color card-border-color-primary">
                    <div class="card-header card-header-divider">Edit Image 3<span class="card-subtitle"></span></div>
                    <div class="card-body">
                        <form name="addpost" method="post" enctype="multipart/form-data">
                            <?php
                            $postid = intval($_GET['pid']);
                            $query = mysqli_query($con, "select postimage2,PostTitle from place where id='$postid' and Is_Active=1 ");
                            ...
                            ?>
                                ...
                                <div class="row text-center">
                                    ...
                                    <div class="col-sm-12  my-3">
                                        <div class="card-box">
                                            <img src="postimages/<?php echo htmlentities($row['postimage2']); ?>" width="500" />
