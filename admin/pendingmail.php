...
<body class="bg-light">
  ...
  <div class="be-wrapper be-aside be-fixed-sidebar">
    <nav class="navbar navbar-expand fixed-top be-top-header">
      ...
      <div class="page-title"><span>Pending Mail</span></div>
    ...
    <div class="be-content be-no-padding">
      ...
      <div class="main-content container-fluid">
        <div class="email-inbox-header">
          <div class="row">
            <div class="col-lg-6">
              <div class="email-title"><span class="icon mdi mdi-inbox"></span> Pending Mails <span class="new-messages">(
                  ...
                  $otv1 = mysqli_num_rows($otv);
                  ?>
                  <?php echo $otv1; ?> new messages)</span> </div>
            </div>
        ...
        <?php $rt = mysqli_query($con, "select * from ticket where status='Open' order by id desc");
