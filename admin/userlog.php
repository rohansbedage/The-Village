...
<body>
    ...
    <div class="be-wrapper be-fixed-sidebar">
        <nav class="navbar navbar-expand fixed-top be-top-header">
            ...
            <div class="page-title"><span>User Access Log</span></div>
                                ...
                                <ul class="sidebar-elements">
                                    ...
                                    <li class="parent"><a href="#"><i class="icon mdi mdi-accounts"></i><span>Users</span></a>
                                        <ul class="sub-menu">
                                            ...
                                            <li class="active"><a href="userlog.php">User Access Log</a>
                                            </li>
        ...
        <div class="be-content">
            <div class="page-head">
                <h2 class="page-head-title">View User Access Log </h2>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb page-head-nav">
                        <li class="breadcrumb-item"><a href="#">Admin</a></li>
                        <li class="breadcrumb-item"><a href="#">Users</a></li>
                        <li class="breadcrumb-item active">User Access Log</li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-table">
                            <div class="card-header">User Access Log
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_array($ret)) { ?>
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td><?php echo $row['logindate']; ?> | <?php echo $row['logintime']; ?> </td>
