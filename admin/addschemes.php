...
<body>
    ...
    <div class="be-wrapper be-fixed-sidebar">
                            ...
                            <div class="left-sidebar-content">
                                ...
                                <ul class="sidebar-elements">
                                    ...
                                    <li class="parent"><a href=""><i class="icon mdi mdi-format-list-numbered"></i><span>Schemes</span></a>
                                        <ul class="sub-menu">
                                            <li class="active"><a href="addschemes.php">Add Schemes</a> </li>
        ...
        <div class="be-content">
            <div class="page-head">
                <h2 class="page-head-title">Add Schemes</h2>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-border-color card-border-color-primary">
                            <div class="card-header card-header-divider">Add Schemes<span class="card-subtitle">Parsley different validation types</span></div>
                            <div class="card-body">
                                <?php include 'upload.php'; ?>
                                <form action="addschemes.php" method="post" enctype="multipart/form-data">

                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Category</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input class="form-control" type="text" required="" value="" name="name" placeholder="Enter Scheme Name ">
                                        </div>
                                    </div>
                                    <?php
                                    $db = mysqli_connect("localhost", "root", "", "rohan");
                                    $code = "SELECT * FROM schmecat";
                                    $res = mysqli_query($db, $code);

                                    ?>
                                    <div class="form-group row pt-1">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Select Scheme Category </label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <select class="form-control" name="catagory">
                                                <?php

                                                while ($row = mysqli_fetch_assoc($res)) { ?>
                                                    <option value="<?php echo $row['schmename'] ?>" selected=""><?php echo $row['schmename'] ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Upload File</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                    ...
                                    <div class="form-group row text-right">
                                        <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                            <input type="text" name="date" value="<?php echo $da;  ?>" hidden>
