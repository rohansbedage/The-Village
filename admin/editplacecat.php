...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "Update  placecat set CategoryName='$category',Description='$description' where id='$catid'");
    if ($query) {
...
<head>
    ...
    <title>Edit Place Category</title>
...
<body>
    ...
    <div class="be-wrapper be-fixed-sidebar">
        ...
        <div class="be-content">
            <div class="page-head">
                <h2 class="page-head-title">Edit Place Category</h2>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb page-head-nav">
                        <li class="breadcrumb-item"><a href="#">Admin</a></li>
                        <li class="breadcrumb-item"><a href="#">Village places</a></li>
                        <li class="breadcrumb-item active">Edit Place Category</li>
                    </ol>
                </nav>
            </div>
            <div class="main-content container-fluid">
                ...
                <?php
                $catid = intval($_GET['cid']);
                $query = mysqli_query($con, "Select id,CategoryName,Description,PostingDate,UpdationDate from  placecat where Is_Active=1 and id='$catid'");
                $cnt = 1;
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-border-color card-border-color-primary">
                                <div class="card-header card-header-divider">Edit Placecategory<span class="card-subtitle"></span></div>
                                <div class="card-body">
                                    ...
                                    <div class="form-group row text-right">
                                        <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                            <button class="btn btn-space btn-primary" type="submit" name="submit">Update</button>
