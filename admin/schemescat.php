  ...
  <div class="be-wrapper be-fixed-sidebar">
                ...
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href=""><i class="icon mdi mdi-format-list-numbered"></i><span>Schemes</span></a>
                    <ul class="sub-menu">
                      ...
                      <li class="active"><a href="schemescat.php">Add Scheme Category</a> </li>
    ...
    <div class="be-content">
      ...
      if (isset($_POST['upload'])) {
        ...
        $sql = "INSERT INTO schmecat (schmename) VALUES ('$name')";
        // Execute query
        mysqli_query($db, $sql);
      }
      ...
      <div class="main-content container-fluid">
        <div class="card text-center">
          <div class="card-header card-header-divider">Add Category in schemes<span class="card-subtitle"></span></div>
          <div class="card-body">
            <form method="POST" action="" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-4 col-lg-3">
                  <input type="submit" class="btn btn-primary btn-lg btn-block" name="upload" value="Add Category">
      ...
      if ($type == 'temp') {
        ...
        $id = $_GET['id'];
        if ($saurabh == 'deactive') {
          $update_status_sql2 = "DELETE FROM schmecat where id='$id'";
