...
if (isset($_POST['submit'])) {
    ...
    $Age = $_POST['Age'];
    $gender = $_POST['gender'];
    $query = mysqli_query($con, "Update  Patient set PatientName='$category',Age='$Age',gender='$gender' where id='$catid'");
    if ($query) {
...
<body>
    ...
    <div class="be-wrapper be-fixed-sidebar">
                                ...
                                <ul class="sidebar-elements">
                                    ...
                                    <li class="parent "><a href="#"><i class="icon mdi mdi-hospital"></i><span> Medical
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="active"><a href="AddPatient.php">Add Patient</a>
                                            </li>
        ...
        <div class="be-content">
            <div class="page-head">
                <h2 class="page-head-title">Edit Patient details</h2>
                ...
                <div class="row ">
                    ...
                    <div class="col-md-12 ">
                        <div class="container my-5">
                            ...
                            <?php
                            $catid = intval($_GET['cid']);
                            $query = mysqli_query($con, "Select id,PatientName,Age,gender,UpdationDate from  Patient where PatientStatus='Active' and id='$catid'");
                            $cnt = 1;
                            ...
                            ?>
                                ...
                                <div class="col-md-12">
                                    <div class="card card-border-color card-border-color-primary shadow">
                                        <div class="card-header card-header-divider">Edit Patient details <span class="card-subtitle">Patient Details</span></div>
                                        <div class="card-body">
                                            <form action="#" style="border-radius: 0px; " name="category" method="post">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                        <input type="text" class="form-control" value="<?php echo htmlentities($row['PatientName']); ?>" name="category" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Patient Age:</label>
                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                        <input type="text" class="form-control" value="<?php echo htmlentities($row['Age']); ?>" name="Age" required>

                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Patient's Category :</label>
                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                        <input type="text" class="form-control" value="<?php echo htmlentities($row['gender']); ?>" name="gender" required>
                                            ...
                                            <div class="form-group row pt-1">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Select Patient's Category :</label>
                                                <div class="col-12 col-sm-8 col-lg-6 form-check mt-1">
                                                    <label class="custom-control custom-radio custom-control-inline">
                                                        <input class="custom-control-input" type="radio" name="gender" value="male">
                                                        <span class="custom-control-label custom-control-color">Male</span>
                                                    </label>
                                                    <label class="custom-control custom-radio custom-control-inline">
                                                        <input class="custom-control-input" type="radio" name="gender" value="female">
                                                        <span class="custom-control-label custom-control-color">Female</span>
                                                    </label>
                                                    <label class="custom-control custom-radio custom-control-inline">
                                                        <input class="custom-control-input" type="radio" name="gender" value="child">
                                                        <span class="custom-control-label custom-control-color">Child</span>
                                                    </label>
                                                    <label class="custom-control custom-radio custom-control-inline">
                                                        <input class="custom-control-input" type="radio" name="gender" value="old age">
                                                        <span class="custom-control-label custom-control-color">Old Age</span>
                                                    </label>
                                                </div>
