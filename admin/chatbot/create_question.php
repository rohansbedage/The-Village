...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($newQuestion) && !empty($newResponse)) {
        // Insert the new question and response into the admin_questions table
        $query = "INSERT INTO admin_questions (question, response) VALUES ('$newQuestion', '$newResponse')";
            ...
            <div class="page-head">
                ...
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb page-head-nav">
                        ...
                        <li class="breadcrumb-item active">Create New Question Response</li>
                    </ol>
                </nav>
                <br><br>
                <!----------------------------------------------------------------------------------------------------------------------->
                ...
                <div class="card card-outline card-info">
                    <div class="card-header">
                        <h3 class="card-title">Create New Question Response</h3>
                    </div>
                    <?php if (!empty($error)) : ?>
                        ...
                        <form method="post" action="" id="response-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="new_question" name="new_question" value="<?php echo $newQuestion; ?>">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="new_response" name="new_response" class="form-control" rows="4" cols="50"><?php echo $newResponse; ?></textarea>
                            </div>
                        </form>
                    </div>
