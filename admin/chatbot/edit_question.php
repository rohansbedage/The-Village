...
// Fetch the existing question and response from the admin_questions table
if ($id) {
    $query = "SELECT question, response FROM admin_questions WHERE id = $id";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $newResponse = $_POST['new_response'];

    // Check if the new question and response are not blank
    if (!empty($newQuestion) && !empty($newResponse)) {
        // Update the question and response in the database
        $updateQuery = "UPDATE admin_questions SET question='$newQuestion', response='$newResponse' WHERE id=$id";

        if (mysqli_query($connection, $updateQuery)) {
            // Redirect to admin_questions.php on successful insert
            header('Location: admin_questions.php');
            exit;
        } else {
            $error = "Error adding question and response: " . mysqli_error($connection);
        }
    } else {
        $error = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Question and response cannot be blank.";
    }
}
                                ...
                                <ul class="sidebar-elements">
                                    ...
                                    <li class="parent"><a href=""><i class="icon mdi mdi-odnoklassniki"></i><span>ChatBot</span></a>
                                        <ul class="sub-menu">
                                            ...
                                            <li class="active"><a href="admin_questions.php">ChatBot Responces</a>
                                            </li>
            ...
            <div class="page-head">
                ...
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb page-head-nav">
                        ...
                        <li class="breadcrumb-item active">List of Questions Responses</li>
                        <li class="breadcrumb-item active">Edit Question and Response</li>
                    </ol>
                </nav>
                <br><br>
                <div class="card card-outline card-info">
                    <div class="card-header">
                        <h3 class="card-title">Edit Question and Response</h3>
                    </div>
                    <?php if (!empty($error)) : ?>
                        ...
                        <form method="post" action="" id="response-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="new_question" name="new_question" value="<?php echo $question; ?>">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="new_response" name="new_response" class="form-control" rows="4" cols="50"><?php echo $response; ?></textarea>
                            </div>
                        </form>
                    </div>
                    <div class="card-footer">
                        <button class="btn btn-flat btn-primary" type="submit" value="Update" form="response-form">Update Response</button>

                        <a class="btn btn-flat btn-default" href="admin_questions.php">Cancel</a>
                    </div>
                </div>
                <!---------------------------------------------  Main content End ------------------------------------------------------------------------------->
