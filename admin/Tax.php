...
<body>
    ...
    <div class="be-wrapper be-fixed-sidebar">
        ...
        if (isset($_POST['save'])) {
            $name = $_POST['name'];
            $sql = "UPDATE user SET Penalty='$name' where Paymentstatus='0'";
            if (mysqli_query($conn, $sql)) {
                echo "<script>alert('Penelty Added');</script>";
        ...
        <div class="be-content">
            <div class="main-content container-fluid">
                <div class="card text-center">
                    ...
                    ?>
                        <div class="card-header card-header-divider">From Date : <?php echo $lit; ?> &nbsp; Due Date : <?php echo $pop; ?><span class="card-subtitle">Apply Penalty</span></div>
                    <?php      } ?>
                        ...
                        <form action="Tax.php" method="POST">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                                    <input class="form-control" type="text" name="name" id="pass2" required="" placeholder="Penalty">
                                </div>
                                <div class="col-sm-4 col-lg-3">
                                    <input class="btn btn-primary btn-lg btn-block" type="submit" name="save" value="Apply Penalty">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card card-table">
                        <div class="card-header">Tax Entries
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <form name="abc" action="" method="post">
                                                    ...
                                                    <a href="AddTax.php?id=<?php echo $row['id']; ?>" type="button" class="btn btn-space btn-primary ">View Penalty</a>
