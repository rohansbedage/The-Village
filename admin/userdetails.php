...
if (isset($_POST['update'])) {
    ...
    $gender = $_POST['gender'];
    $userid = $_GET['id'];
    $ret = mysqli_query($con, "update user set name='$name',firstname='$firstname',lastname='$lastname',Age='$Age',email='$email',mobile='$contact',gender='$gender',address='$address' where id='$userid'");
}
    ...
    <div class="be-wrapper be-fixed-sidebar">
        ...
        <div class="card-body">
            ...
            <div class="be-content">
                <div class="page-head">
                    <h2 class="page-head-title">User-details</h2>
                                                    ...
                                                    <form class="form-horizontal group-border-dashed" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-12 col-sm-8 col-lg-6">
                                                                <input class="form-control" name="name" id="name" type="text" value="<?php echo $rw['name']; ?>">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-12 col-sm-3 col-form-label text-left text-sm-right">Age</label>
                                                            <div class="col-12 col-sm-8 col-lg-6">
                                                                <input class="form-control" name="Age" id="Age" type="text" value="<?php echo $rw['Age']; ?>">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-12 col-sm-8 col-lg-6">
                                                                ...
                                                                <input class="form-control" name="email" id="email" type="text" value="<?php echo $rw['email']; ?>">
                                                            ...
                                                            <div class="col-12 col-sm-8 col-lg-6">
                                                                <div class="input-group">
                                                                    ...
                                                                    <select class="form-control select" name="gender">
                                                                        <option value="<?php echo $rw['gender']; ?>"><?php $a = $rw['gender'];
                                                                                                                        if ($a == 'male') {
                                                                                                                            echo "Male";
                                                                                                                        }
