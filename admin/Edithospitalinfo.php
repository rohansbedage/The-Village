...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "Update  hospital set HospitalName='$category',AvailableNormalBeds='$AvailableNormalBeds',TotalNormalBeds='$TotalNormalBeds',AvailableVentilatorBeds='$AvailableVentilatorBeds',TotalVentilatorBeds='$TotalVentilatorBeds' where id='$catid'");
    if ($query) {
...
<head>
    ...
    <title>Edit Hospital Info </title>
...
<div class="be-wrapper be-fixed-sidebar">
    ...
    <div class="be-content">
        <div class="page-head">
            <h2 class="page-head-title"> Edit Hospital Info </h2>
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb page-head-nav">
                    <li class="breadcrumb-item"><a href="#">Admin</a></li>
                    <li class="breadcrumb-item"><a href="#">Important</a></li>
                    <li class="breadcrumb-item active">Edit Hospital Info</li>
                </ol>
            </nav>
            <br>
            ...
            <div class="row ">
                ...
                <div class="col-md-12 ">
                    <div class="container my-5">
                        ...
                        <?php
                        $catid = intval($_GET['cid']);
                        $query = mysqli_query($con, "Select id,HospitalName,AvailableNormalBeds,TotalNormalBeds,AvailableVentilatorBeds,TotalVentilatorBeds,UpdationDate from  hospital where hospitalStatus='Active' and id='$catid'");
                        $cnt = 1;
                        ...
                        ?>
                            ...
                            <div class="col-md-12">
                                <div class="card card-border-color card-border-color-primary shadow">
                                    <div class="card-header card-header-divider">Edit Hospital Info <span class="card-subtitle">hospital Details</span></div>
                                    <div class="card-body">
                                        <form action="#" style="border-radius: 0px; " name="category" method="post">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" value="<?php echo htmlentities($row['HospitalName']); ?>" name="category" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Available NormalBeds:</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" value="<?php echo htmlentities($row['AvailableNormalBeds']); ?>" name="AvailableNormalBeds" required>

                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Total NormalBeds:</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" value="<?php echo htmlentities($row['TotalNormalBeds']); ?>" name="TotalNormalBeds" required>

                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Available VentilatorBeds:</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" value="<?php echo htmlentities($row['AvailableVentilatorBeds']); ?>" name="AvailableVentilatorBeds" required>

                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Total VentilatorBeds:</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" value="<?php echo htmlentities($row['TotalVentilatorBeds']); ?>" name="TotalVentilatorBeds" required>
