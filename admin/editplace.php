...
if (isset($_POST['update'])) {
    ...
    $query = mysqli_query($con, "update place set PostTitle='$posttitle',CategoryId='$catid',SubCategoryId='$subcatid',PostDetails='$postdetails',PostUrl='$url',Is_Active='$status' where id='$postid'");
    if ($query) {
        $msg = "Post updated ";
    } else {
...
<body>
    ...
    <div class="be-wrapper be-fixed-sidebar">
        ...
        <div class="be-content">
            <div class="page-head">
                <h2 class="page-head-title">Edit Place details</h2>
            ...
            <div class="main-content container-fluid">
                <?php
                $postid = intval($_GET['pid']);
                $query = mysqli_query($con, "select place.id as postid,place.PostImage,place.PostImage1,place.PostImage2,place.PostTitle as title,place.PostDetails,placecat.CategoryName as category,placecat.id as catid,placesubcat.SubCategoryId as subcatid,placesubcat.Subcategory as subcategory from place left join placecat on placecat.id=place.CategoryId left join placesubcat on placesubcat.SubCategoryId=place.SubCategoryId where place.id='$postid' and place.Is_Active=1 ");
                while ($row = mysqli_fetch_array($query)) {
                ?>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-border-color card-border-color-primary">
                                <div class="card-header card-header-divider">Edit Place<span class="card-subtitle"></span></div>
                                <div class="card-body">
                                    <form name="addpost" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <textarea class="form-control" name="postdescription" required><?php echo htmlentities($row['PostDetails']); ?></textarea>
                                        ...
                                        <div class="row g-4 my-4  mx-5">
                                            ...
                                            <div class="col-auto mx-5">
                                                ...
                                                <div class="controls ">
                                                    <br>
                                                    <div class="img
                                                                        Max-height=200"><img src="postimages/<?php echo htmlentities($row['PostImage']); ?>" alt="Gallery
                                                        ...
                                                        <div class="func">
                                                            ...
                                                            <button type="button" class="btn
                                                                                ...
                                                                                shadow">
                                                                &nbsp; &nbsp;&nbsp;&nbsp;
                                                                <a class="image-zoom" href="change-image.php?pid=<?php echo htmlentities($row['postid']); ?>">
                                                                    Image
                                                                    1</a>
                                                                &nbsp; &nbsp;&nbsp;&nbsp;
                                                            </button>
                                            ...
                                            <div class="col-auto mx-2">
                                                ...
                                                <div class="controls">
                                                    <br>
                                                    <div class="img"><img src="postimages/<?php echo htmlentities($row['PostImage1']); ?>" alt="Gallery
                                                                        Image" width="300" height="170" class="">
                                                        <br><br>
                                                        <div class="func">
                                                            ...
                                                            <button type="button" class="btn
                                                                ...
                                                                <a class="image-zoom" href="change-image1.php?pid=<?php echo htmlentities($row['postid']); ?>">
                                                                    Image
                                                                    2</a>
                                            ...
                                            <div class="col-auto mx-2">
                                                ...
                                                <div class="controls">
                                                    <br>
                                                    <div class="img
                                                                        Max-height=200"><img src="postimages/<?php echo htmlentities($row['PostImage2']); ?>" alt="Gallery
                                                                        Image" width="300" height="170" class="">
                                                        <br><br>
                                                        <div class="func">
                                                            &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                                            <button type="button" class="btn btn-white shadow">
                                                                &nbsp; &nbsp;&nbsp;&nbsp;
                                                                <a class="image-zoom" href="change-image2.php?pid=<?php echo htmlentities($row['postid']); ?>"> Image 3</a>
                                                                &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            </button>
                                                        </div>
                                                    </div>
