...
if ($_GET['action'] == 'del' && $_GET['rid']) {
    $id = intval($_GET['rid']);
    $query = mysqli_query($con, "update placecat set Is_Active='0' where id='$id'");
...
if ($_GET['resid']) {
    ...
    $query = mysqli_query($con, "update placecat set Is_Active='1' where id='$id'");
...
if ($_GET['action'] == 'parmdel' && $_GET['rid']) {
    $id = intval($_GET['rid']);
    $query = mysqli_query($con, "delete from  placecat  where id='$id'");
...
<body>
    ...
    <div class="be-wrapper be-fixed-sidebar">
                                ...
                                <ul class="sidebar-elements">
                                    ...
                                    <li class="parent "><a href="#"><i class="icon mdi mdi-google-maps"></i><span>
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="active"><a href="manageplacecat.php">Manage Place category </a></li>
        ...
        <div class="be-content">
            <div class="page-head">
                <h2 class="page-head-title">Place Categories</h2>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb page-head-nav">
                        <li class="breadcrumb-item"><a href="#">Admin</a></li>
                        <li class="breadcrumb-item"><a href="#">Village places</a></li>
                        <li class="breadcrumb-item active">Place categories</li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-table">
                            <div class="card-header">Place Categories
                            ...
                            <div class="card-body">
                                <table class="table table-striped table-hover table-fw-widget" id="table3">
                                    ...
                                    <tbody>
                                        <?php
                                        $query = mysqli_query($con, "Select id,CategoryName,Description,PostingDate,UpdationDate from  placecat where Is_Active=1");
                                        $cnt = 1;
                                        ...
                                        ?>
                                            ...
                                            <tr class="odd gradeX text-center">
                                                ...
                                                <td>
                                                    &nbsp;
                                                    <a class="btn btn-secondary" type="button" href="editplacecat.php?cid=<?php echo htmlentities($row['id']); ?>">Edit</a>

                                                    <a class="btn btn-secondary" type="button" href="manageplacecat.php?rid=<?php echo htmlentities($row['id']); ?>&&action=parmdel"> Delete</a>
