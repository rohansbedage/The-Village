  ...
  <body>
    ...
    <div class="jumbotron jumbotron-fluid bg-light text-center">
      ...
      <div class="jumbotron jumbotron-fluid bg-light ">
        <div class="container">
          <div class="w3-content w3-display-container mx-5">
            <img class="mySlides" src="images/home/1.jpeg" width="1110rem" height="380em">
            <img class="mySlides" src="images/home/2.jpeg" width="1110rem" height="380em">
            <img class="mySlides" src="images/home/3.jpeg" width="1110rem" height="380em">
      ...
      <div class="container px-4 py-5" id="icon-grid">
        <h2 class="pb-2 border-bottom">The Village </h2>
        <p>(The Village)</p>
