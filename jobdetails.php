                            ...
                            <article class="blog-post ">
                                ...
                                <div class="featured-post">
                                    <h2 class="text-center text-uppercase my-5">
                                        <b> Job Name : <?php echo $name; ?></b>

                                    </h2>
                                    <a href="#">
                                        <img width="600" height="300" src="admin/image/<?php echo $img; ?>" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="p1" />
                                    </a>
                                </div>
                                <div class="divider25"></div>
                                <div class="content my-3">
                                    <h3 class="title ">
                                        <a href="#">Job Name : <?php echo $name; ?></a>
                                    </h3>

                                    <div class="entry-post">
                                        <p>
                                        <h4>Job Description : <?php echo $des; ?>.</p>
                                            <hr>

                                            <div class="more-link">
                                                <a class="btn btn-primary btn-lg btn-block" href="confirmation.php?id=<?php echo $id ?>">Apply For This Job</a>
                                                <br>
                                            </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-3 sidebar ">
                        ...
                        <div class="widget widget-categories shadow-lg">
                            ...
                            <ul class="cat-list">
                                ...
                                ?>
                                    <li>
                                        <a href="jobpost.php?id=<?php echo $jobcat ?>"><i class="fas fa-chevron-right"></i> <?php echo $jobcat ?><span>(03)</span></a>
                                    </li>
