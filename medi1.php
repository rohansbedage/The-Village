          ...
          <div class="owl-carousel owl-theme bg-light">
            ...
            ?> <div class="card text-center   shadow-lg my-2" style="width: 20rem;">
                <div class="card-body ">
                  ...
                  <h4 class="text-success shadow-lg"><br> <b> Available Normal Beds : <br> <?php echo htmlentities($row['AvailableNormalBeds']); ?> <br><br></b> </h4>
                  <hr>
                  <h4 class="text-success shadow-lg"> <br> <b> Hospital Ventilator Bed : <br> <?php echo htmlentities($row['AvailableVentilatorBeds']); ?></b> <br><br></h4>
                  <hr>
